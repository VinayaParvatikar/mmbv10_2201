...
class TestMMB():
    ...
    def test_enabling_disabling_columns(self):
        ...
        time.sleep(1)
        select_agg_column = self.driver.find_element_by_xpath('/html/body/div[10]/div[1]/div/label')
        ...
        # time.sleep(1)
        select_fringes_column = self.driver.find_element_by_xpath('/html/body/div[10]/div[2]/div/label')
        select_fringes_column.click()
        time.sleep(1)
        select_groups_column = self.driver.find_element_by_xpath('/html/body/div[10]/div[3]/div/label')
        select_groups_column.click()
        time.sleep(1)
        select_location_column = self.driver.find_element_by_xpath('/html/body/div[10]/div[4]/div/label')
        select_location_column.click()
        time.sleep(1)
        select_set_column = self.driver.find_element_by_xpath('/html/body/div[10]/div[5]/div/label')
        select_set_column.click()

    def test_right_click_operation(self):
        action = ActionChains(self.driver)
        right_click_selected_row = self.driver.find_element_by_xpath(
            '//*[@id="root"]/div/div[2]/div[2]/div[1]/div[1]/div/div[2]/div/'
        ...
        create_new_location = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[2]/div[2]/div[1]/div[1]/div/'
                                                                'div[2]/div/div[2]/div/div[1]/div[6]/div[1]/div[1]/div/'
                                                                'div[2]/div/div/button[2]')
        ...
        time.sleep(3)
        create_new_set = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[2]/div[2]/div[1]/div[1]/div/div[2]/'
                                                           'div/div[2]/div/div[1]/div[7]/div[1]/div[1]/div/div[2]/div/'
                                                           'div/button[2]')
        create_new_set.click()
        time.sleep(3)
        select_field = self.driver.find_element_by_xpath(
            '//*[@id="root"]/div/div[2]/div[2]/div[1]/div[1]/div/div[2]/div/div[2]/div/div[1]/div[8]')
        action = ActionChains(self.driver)
    ...
    def test_enable_setups(self):
        ...
        enable_fringe_1 = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[2]/div[2]/div[1]/div[4]/div/div/'
                                                            'div[1]/div/div[1]/div[2]/div/div[2]/div[1]/div[2]/div/'
                                                            'div[1]/div[2]/div')
        ...
        enable_group = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[2]/div[2]/div[1]/div[4]/div/div/'
                                                         'div[4]/div/div/div[2]/div/div[2]/div/div[2]/div/div[2]/'
                                                         'div[2]/div')
    ...
    def test_add_credit(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[1])
        time.sleep(1)
        add_credit = self.driver.find_element_by_xpath(
            '//*[@id="root"]/div/div[1]/div[2]/div/div/div[4]/div/div/button')
        add_credit.click()
        time.sleep(1)
    ...
    def test_add_note(self):
        ...
        edit_note = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[2]/div[2]/div[1]/div[4]/div/div/div[4]/'
                                                      'div/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div[1]/'
                                                      'div/textarea')
    ...
    def test_add_fringes(self):
        ...
        select_fringes_setup = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[2]/div[2]/div[1]/div[4]/div/'
                                                                 'div/div[1]/div/div[1]/div[2]/div/div[1]/div[2]/div/a')
        ...
        self.edit_field(fringe_name, fringe_name_string)
        time.sleep(1)
    ...
    def test_add_charges(self):
        charges_setup = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/button[9]')
        charges_setup.click()
        time.sleep(2)
        self.driver.implicitly_wait(5)
        self.driver.switch_to.window(self.driver.window_handles[1])
        time.sleep(1)
        add_charge = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[4]/div/div/'
                                                       'button')
        add_charge.click()
        time.sleep(1)
        charge_rename = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[4]/div/div[1]'
                                                          '/div[1]/div/div/input')
        charge_rename.click()
        time.sleep(1)
        charge_rename.clear()
        charge_rename.send_keys('CH1')
        time.sleep(1)
        charge_rename.send_keys(Keys.TAB)
       # charge_type_percent = self.driver.find_element_by_xpath('//*[@id="percent"]/span')
        charge_type_percent = self.driver.find_element_by_id('percent')
        charge_type_percent.click()
        time.sleep(1)
        charge_type_dropdown = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[4]/div/'
                                                                 'div[1]/div[2]/div[1]/div/i')
        charge_type_dropdown.click()
        time.sleep(1)
        #charge_type_flat_fee = self.driver.find_element_by_xpath('//*[@id="flat_fee"]/span')
        charge_type_flat_fee = self.driver.find_element_by_id('flat_fee')
        charge_type_flat_fee.click()
        time.sleep(1)
        charge_type = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[4]/div/div[1]/'
                                                        'div[2]/div[1]/div')
        charge_type.send_keys(Keys.TAB)
        time.sleep(1)
        charge_amount = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[4]/div/div[1]/'
                                                          'div[2]/div[2]/div[1]/div/input')
        charge_amount.send_keys('100')
        charge_amount.send_keys(Keys.TAB)
        time.sleep(1)
        charge_base = self.driver.find_element_by_id('CDrmUOxPKgU$')
        charge_base.click()
        base_tab = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[4]/div/div[1]/'
                                                     'div[2]/div[2]/div[2]/div')
        base_tab.send_keys(Keys.TAB)
        time.sleep(1)
        edit_acccount_number = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[4]/div/'
                                                                 'div[1]/div[2]/div[3]/div/input')
        edit_acccount_number.send_keys('10001')
        time.sleep(1)
        edit_acccount_number.send_keys(Keys.TAB)
        time.sleep(1)
        display_topsheet_desc_perc = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[4]/div/'
                                                                  'div[1]/div[3]/div[2]/div/div[1]/div')
        display_topsheet_desc_perc.click()
        time.sleep(1)
        display_topsheet_desc_perc.send_keys(Keys.TAB)
        time.sleep(1)
    '''
    ...
    def test_budget_compare(self):
        ...
        searched_budget = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[3]/button[3]/div/div[2]/'
                                                            'div/div/div/div[2]/div/div/div[2]/span')
    ...
    '''
    def test_budget_share(self):
        email_id = 'vinaya.parvatikar@accionlabs.com'
        share_budget = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[1]/button[2]')
        share_budget.click()
        #self.driver.implicitly_wait(10)
        time.sleep(5)
        self.driver.switch_to.window(self.driver.window_handles[1])
        add_recipient = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[3]/div[1]/a[1]')
        add_recipient.click()
        time.sleep(5)
        select_recipient_field = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[3]/div[2]/div/div[2]/div/'
                                                                   'div/div[1]')
        action = ActionChains(self.driver)
        action.double_click(select_recipient_field)
        action.perform()
        edit_email_field = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[3]/div[2]/div/div[2]/div/div/'
                                                             'div[1]/input')
        edit_email_field.send_keys(email_id)
        time.sleep(5)
        name_recipient_field = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[3]/div[2]/div/div[2]/div/'
                                                                 'div/div[2]')
        action = ActionChains(self.driver)
        ...
        send_tab = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[3]/div[2]/div/div[2]/div/div/div[5]/'
                                                     'button')
        send_tab.click()
        time.sleep(2)
        delete_recipient = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[3]/div[1]/a[2]')
        delete_recipient.click()
        time.sleep(2)
        delete_tab = self.driver.find_element_by_xpath('/html/body/div[4]/div/div[3]/button[1]')
        delete_tab.click()
        time.sleep(2)
        close_share_window = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[4]/div/button')
        close_share_window.click()
        time.sleep(2)
        self.driver.switch_to.window(self.driver.window_handles[0])
        time.sleep(2)
        select_open_new_tab = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[1]/button[1]')
        select_open_new_tab.click()
        time.sleep(2)
        self.driver.switch_to.window(self.driver.window_handles[1])
        time.sleep(2)
        shared_with_me_dropdown = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[1]/'
                                                                    'div/div/div[3]/i')
        shared_with_me_dropdown.click()
        time.sleep(5)
        sender_email = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[1]/div/div/'
                                                         'div[4]/div/div/div[3]/div/span')
        assert sender_email.text == email_id
        # sender_email.click()
        # time.sleep(5)
        # shared_budget = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[4]/div/div[2]/'
        #                                                   'div/div[2]/div/div[1]/div[2]/span')
        # assert shared_budget.text == budget_name
        # archive_shared_budget = self.driver.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/div/div[4]/'
        #                                                           'div/div[1]/a[2]')
        # archive_shared_budget.click()
